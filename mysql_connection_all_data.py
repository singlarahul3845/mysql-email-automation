...
excluded_email_extensions = []  # Add any email extensions you want to exclude
...
def email_exists_in_db(cursor, email):
    try:
        query = "SELECT COUNT(*) FROM all_user_data WHERE Email = %s"
...
def insert_data_from_file(df):
    ...
    for index, row in df.iterrows():
        ...
        insert_query = """
        INSERT INTO all_user_data (Name, Email, Account_Timestamp, No_Of_Downloads, Download_URLs, Visited_URLs, Free_or_Paid)
